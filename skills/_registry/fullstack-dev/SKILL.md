---
name: fullstack-dev
description: Full-stack backend architecture and frontend-backend integration guide. TRIGGER when: building full-stack app, REST API with frontend, scaffolding backend, CRUD app, real-time app, Express+React, Next.js API, Node.js/Python/Go backend. DO NOT TRIGGER when: pure frontend UI, pure CSS/styling, database schema only.
license: MIT
metadata:
  category: full-stack
  version: "1.0.0"
