...
**Must** use `_skills/pdf/scripts/compile_latex.py` script to compile. The script will automatically:
...
```bash
# Single compilation
python3 _skills/pdf/scripts/compile_latex.py main.tex

# Multiple runs (for cross-references and bibliography)
python3 _skills/pdf/scripts/compile_latex.py main.tex --runs 2

# Keep full logs (for debugging)
python3 _skills/pdf/scripts/compile_latex.py main.tex --keep-logs
```
...
python3 _skills/pdf/scripts/compile_latex.py main.tex --runs 3
```
