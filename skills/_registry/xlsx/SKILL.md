...
**Executable Path**: `_skills/xlsx/scripts/KimiXlsx`

**Base Command**: `_skills/xlsx/scripts/KimiXlsx <command> [arguments]`
...
- how to use:
```bash
_skills/xlsx/scripts/KimiXlsx recheck output.xlsx
```
...
- how to use:
```bash
_skills/xlsx/scripts/KimiXlsx reference-check output.xlsx
```
...
_skills/xlsx/scripts/KimiXlsx inspect input.xlsx --pretty
```
...
- **⚠️ CRITICAL**: Before using this command, you MUST read `_skills/xlsx/pivot-table.md` for full documentation.
- required parameters:
...
_skills/xlsx/scripts/KimiXlsx inspect data.xlsx --pretty

# Then: create PivotTable with chart
_skills/xlsx/scripts/KimiXlsx pivot \
...
- how to use:
```bash
_skills/xlsx/scripts/KimiXlsx chart-verify output.xlsx
```
- exit codes:
...
- how to use:
```bash
_skills/xlsx/scripts/KimiXlsx validate output.xlsx
```
...
1. **READ** `_skills/xlsx/pivot-table.md` FIRST
