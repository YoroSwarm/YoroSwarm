-- DropIndex
DROP INDEX "conversation_participants_conversation_id_user_id_key";
...
CREATE TABLE "artifacts" (
    ...
    "metadata" TEXT,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "artifacts_swarm_session_id_fkey" FOREIGN KEY ("swarm_session_id") REFERENCES "swarm_sessions" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "artifacts_owner_agent_id_fkey" FOREIGN KEY ("owner_agent_id") REFERENCES "agents" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "artifacts_source_task_id_fkey" FOREIGN KEY ("source_task_id") REFERENCES "team_lead_tasks" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_agents" ("capabilities", "config", "created_at", "description", "id", "name", "role", "status", "updated_at") SELECT "capabilities", "config", "created_at", "description", "id", "name", "role", "status", "updated_at" FROM "agents";
DROP TABLE "agents";
...
INSERT INTO "new_files" ("created_at", "filename", "id", "metadata", "mime_type", "original_name", "path", "session_id", "size", "user_id") SELECT "created_at", "filename", "id", "metadata", "mime_type", "original_name", "path", "session_id", "size", "user_id" FROM "files";
DROP TABLE "files";
ALTER TABLE "new_files" RENAME TO "files";
CREATE TABLE "new_shared_tasks" (
...
INSERT INTO "new_shared_tasks" ("assignee_id", "completed_at", "created_at", "creator_id", "description", "due_date", "id", "parent_id", "priority", "started_at", "status", "title", "updated_at") SELECT "assignee_id", "completed_at", "created_at", "creator_id", "description", "due_date", "id", "parent_id", "priority", "started_at", "status", "title", "updated_at" FROM "shared_tasks";
DROP TABLE "shared_tasks";
ALTER TABLE "new_shared_tasks" RENAME TO "shared_tasks";
CREATE TABLE "new_team_lead_tasks" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "swarm_session_id" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "description" TEXT,
...
INSERT INTO "new_team_lead_tasks" ("assignee_id", "completed_at", "created_at", "creator_id", "description", "due_date", "id", "parent_id", "priority", "started_at", "status", "title", "updated_at") SELECT "assignee_id", "completed_at", "created_at", "creator_id", "description", "due_date", "id", "parent_id", "priority", "started_at", "status", "title", "updated_at" FROM "team_lead_tasks";
DROP TABLE "team_lead_tasks";
ALTER TABLE "new_team_lead_tasks" RENAME TO "team_lead_tasks";
...
-- CreateIndex
CREATE INDEX "artifacts_swarm_session_id_kind_created_at_idx" ON "artifacts"("swarm_session_id", "kind", "created_at");
