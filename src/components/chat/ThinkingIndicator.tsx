...
export function ThinkingIndicator({ agentName, agentId, role, isThinking, thinkingContent }: ThinkingIndicatorProps) {
  ...
  return (
    <div className="flex gap-3 py-1 animate-slide-up">
      <div className="w-8 shrink-0" />

      <div className="flex flex-col gap-1 max-w-md">
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center gap-1.5 text-[11px] text-muted-foreground bg-muted/50 px-2 py-0.5 rounded-full border border-border/50 animate-pop-in">
        ...
        {latestThought && (
          <div className="bg-muted/30 rounded-lg p-2 text-xs text-muted-foreground border border-border/30 animate-fade-in">
